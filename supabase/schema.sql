...
CREATE TABLE IF NOT EXISTS products (
    ...
    base_unit_id BIGINT NULL REFERENCES units(id) ON DELETE SET NULL,
    default_purchase_unit_id BIGINT NULL REFERENCES units(id) ON DELETE SET NULL,
    default_sale_unit_id BIGINT NULL REFERENCES units(id) ON DELETE SET NULL,
    stock_mode VARCHAR(30) NOT NULL DEFAULT 'own',
    stock_source_id BIGINT NULL,
    consumption_quantity NUMERIC(12, 3) NULL,
...
-- 13. ROW LEVEL SECURITY (RLS) DISABLE & PERMISSION GRANTS
-- Disable RLS on all POS tables so the application frontend can perform direct CRUD
ALTER TABLE IF EXISTS categories DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS products DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS product_batches DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS batch_disposals DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS units DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS packaging_units DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS packaging_stock_adjustments DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS purchase_payments DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS purchase_returns DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS purchase_return_items DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS sales DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS sale_items DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS sale_item_batches DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS payments DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS held_sales DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS held_sale_items DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS access_credentials DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS user_notification_preferences DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE products ADD COLUMN IF NOT EXISTS default_sale_unit_id BIGINT NULL;
ALTER TABLE products ADD COLUMN IF NOT EXISTS stock_mode VARCHAR(30) NOT NULL DEFAULT 'own';
